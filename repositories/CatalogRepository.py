...
class CatalogRepository:
    ...
    def _generate_crm_schema(self, asset_id, data_elements):
        ...
        tables = {
            "customers": [
                {"name": "customer_id", "type": "INT", "data_element": None, "sample": str(random.randint(10000, 99999))},
                ...
                {"name": "address", "type": "VARCHAR", "data_element": "Home Address", "sample": f"{random.randint(1, 999)} {random.choice(['Main', 'Oak', 'Maple', 'Cedar'])} St"},
                {"name": "city", "type": "VARCHAR", "data_element": "City", "sample": random.choice(["New York", "Los Angeles", "Chicago", "Houston", "Phoenix"])},
                {"name": "state", "type": "VARCHAR", "data_element": "State", "sample": random.choice(["CA", "NY", "TX", "FL", "IL"])},
                {"name": "zip", "type": "VARCHAR", "data_element": "Zip Code", "sample": f"{random.randint(10000, 99999)}"},
            ...
            "purchases": [
                ...
                {"name": "amount", "type": "DECIMAL", "data_element": "Purchase Amount", "sample": f"{random.randint(10, 1000)}.{random.randint(0, 99):02d}"},
                {"name": "payment_method", "type": "VARCHAR", "data_element": "Payment Method", "sample": random.choice(["Credit Card", "PayPal", "Bank Transfer", "Cash"])},
            ],
            "interactions": [
